...
export default function Sidebar() {
    ...
    return (
        <>
            <motion.div
                className={`bg-white dark:bg-gray-800 shadow-xl border-r border-gray-200 dark:border-gray-700 flex flex-col min-h-screen transition-all duration-300 overflow-hidden ${
